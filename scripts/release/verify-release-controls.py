...
def main() -> None:
    ...
    for required_contract in (
        ...
        "Expected the exact candidate instrumentation test contract to pass",
        'net.clench.wallet.data.repository.FrozenSigningBoundaryTest',
        'phoneSignerRejectsFrozenRetainedPsbtAndUnfreezeRestoresSigning',
        'rejectedPassphraseFeeBumpLocksEphemeralStateAndRecoversAfterExplicitUnlockAndGraphReload',
        'net.clench.wallet.data.network.NativeElectrumOfflineTest',
        'nativePingWorksThenOfflineClosesCapturedClientTransport',
        'upstreamEofClosesNativeRelayWithoutWaitingForOuterDeadline',
        'nativeUnconfirmedProjectionReplacesCachedConfirmationAndFailedSyncPreservesIt',
        'invalidOwnerAndDuplicateRawOutpointsRejectBeforeWrites',
        'legacyAliasFreezeAppearsInUiAndExplicitUnfreezeClearsOnlyItsWallet',
        'migratedAliasRowsRoundTripBackupWithoutDroppingLabelsOrFreezes',
        'net.clench.wallet.data.repository.FrozenInputRepositoryTest',
        'explicitFrozenSelectionCannotOverridePolicyAndLegacyAliasesStayFrozen',
        'metadataReadFailureStopsPsbtConstruction',
        'retainedDraftRejectsFreezeBeforeAnyBroadcastConnection',
        'singleBatchAndDrainRespectRoomFrozenState',
        'net.clench.wallet.data.repository.TransactionHistorySnapshotTest',
        'authoritativeUnconfirmedReconfirmationEvictionAndReappearanceSurviveRestart',
        'invalidOrInterruptedSnapshotCannotPartiallyDemoteHistory',
        "accountOneDerivesDifferentAddresses",
        "accountZeroMatchesBdkStandardDescriptors",
        "ambiguousLocalMappingRollsBackEarlierWalletWrites",
        "backgroundedRelockAuthenticationCannotPersistRelaxation",
        "collidingImportsPreserveBothWalletsForFrozenAndUnfrozenState",
        "creationAndWatchOnlyConversionPreserveWhitespaceWithoutReinterpretingExistingWallets",
        "encryptedDatabaseRoundTripsWalletWithProductionOpenHelper",
        "encryptedUpgradeAndRestartPreserveWalletScopedMetadata",
        "everySupportedLegacyRoutePreservesSurvivingRowsAndRestarts",
        "exactlyOneKeyPerFieldIsRequiredBeforeAnyWalletPersistence",
        "identicalWalletViewsRetainTheirExplicitOwnersOnRoundTrip",
        "importPreviewStorageUnlockAndReopenedRepositoryHaveTheSameIdentity",
        "interruptedMigrationRollsBackDdlAndRowsThenRetriesSuccessfully",
        "malformedColdAndLockedWarmIntentsRemainContained",
        "malformedWarmIntentsAreContainedAndValidInputStillWorks",
        "migrate12To13CreatesAndValidatesSignerVaultSchema",
        "multipleSourceViewsCannotSilentlyAliasOneExistingWallet",
        "nativeBip39NormalizationIsTheSameForComposedAndDecomposedInput",
        "net.clench.wallet.data.backup.WalletScopedMetadataTest",
        "net.clench.wallet.data.local.ClenchDatabaseMigrationTest",
        "net.clench.wallet.data.local.ClenchDatabaseSqlCipherTest",
        "net.clench.wallet.data.local.WalletScopedMetadataMigrationTest",
        "net.clench.wallet.data.repository.MultisigCreationBoundaryTest",
        "net.clench.wallet.data.repository.PassphraseIdentityBoundaryTest",
        "net.clench.wallet.ui.NfcIntentBoundaryTest",
        "net.clench.wallet.ui.viewmodel.SweepDescriptorFactoryTest",
        "offlineUnknownHistoricalOutpointsAreIsolatedAndCanonicalized",
        "productionPreflightRejectsCorruptionWithoutMutatingWalletFile",
        "relockPinFailureCancellationAndSuccessUseCurrentPin",
        "relockRelaxationRequiresFreshAuthenticationAndSurvivesRestart",
        "repeatedSameWalletImportIntentionallyUpdatesOnlyItsOwnRecord",
        "sharedReceiveDescriptorDoesNotAliasDifferentChangePolicy",
        "singleRowFieldUpdatesNeverReachAnotherWallet",
        "unsupportedOldSchemasFailClosedWithoutReset",
        "viewModelToRepositoryNativeAndRoomRetainsTheReviewedReceiveAndChangePolicy",
        ...
        "fetch-depth: 0",
        "test -e /dev/kvm",
        "Prove passphrase identity across forced process restart",
        "CLENCH_PASSPHRASE_RESTART_DISPOSABLE",
        "scripts/verification/run-passphrase-process-restart.sh",
        "scripts/verification/test-passphrase-process-restart.py",
        "passphrase-process-restart",
