    ...
    Scaffold(
        ...
        Column(
            ...
            BodyText(
                ...
                "SDKs, no telemetry, and no phone-home behavior of any kind."
            )
            ...
            BulletItem("NFC — to communicate with NFC-based hardware wallets (Coldcard). Only active during signing.")
